...
export const EditStudentModal: React.FC<EditStudentModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isValidDirection(facultyOrField)) {
      setErrorMessage("Iltimos, 18 ta rasmiy ta'lim yo'nalishidan birini tanlang.");
      return;
    }
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="sm:col-span-2">
                <DirectionSelect
                  id="admin-edit-student-direction"
                  label="Ta'lim yo'nalishi"
                  required
                  value={facultyOrField}
                  onChange={setFacultyOrField}
